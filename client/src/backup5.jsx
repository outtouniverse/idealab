        ...
        <div className="flex-1 ml-64">
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <Card className="bg-white dark:bg-gray-800 shadow-xl border-0 backdrop-blur-lg">
            ...
            {(response ||
              ...
              <div className="space-y-8">
                ...
                {response && (
                  <section
                    id="overview"
                    className="bg-white/80 dark:bg-gray-900/80 border-0 shadow-xl backdrop-blur-lg"
                  >
                    <Card>
